...
export function Badges() {
  ...
  const specialBadge = badges.find((b) => b.category === 'special' && matchesFilters(b))
  const visible = badges.filter((b) => b.category === activeCategory && matchesFilters(b))
    ...
    <div>
      ...
      {specialBadge && (
        <div className="px-4 pb-2">
          <BadgeGrid badges={[specialBadge]} onSelectBadge={setSelectedBadge} />
        </div>
      )}

      <BadgeCategoryTabs activeCategory={activeCategory} onChange={setActiveCategory} />
